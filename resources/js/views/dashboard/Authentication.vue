                                ...
                                <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                                    <form class="pb-5" v-on:submit.prevent="login">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block">Sign in</button>
                                            ...
                                            <a href="javascript: void(0);" class="link float-right"  v-on:click.prevent="showUserRegisterModal()">Do you have an account? Sign Up</a>
                                </div>
                                <b-modal class="tab-pane fade" ref="userRegisterModal" hide-footer>
